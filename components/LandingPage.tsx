      ...
      <div className="container mx-auto px-4 h-screen flex flex-col md:flex-row items-center justify-center relative z-10">
        ...
        <div className="flex-1 text-center md:text-left space-y-8 animate-slide-up">
          ...
          <h1 className="text-5xl md:text-7xl font-black leading-tight tracking-tight">
            Hệ Thống Ôn Thi <br />
            <span className="text-gradient">Công Nghệ Thông Minh</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            ...
            <button className="px-8 py-4 rounded-xl bg-white text-gray-700 font-medium border border-gray-200 hover:bg-gray-50 transition-all shadow-sm hover:shadow-md">
              Xem Demo
            </button>
          </div>
...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; desc: string }> = ({ icon, title, desc }) => (
  <div className="glass-card p-6 rounded-2xl hover:bg-white/80 transition-all cursor-default">
