          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <div className="mt-3 flex items-center gap-4 text-sm">
                ...
                <span className={`px-3 py-1 rounded-full font-bold ${exam.percentage >= 80 ? 'bg-green-500' :
            ...
            <div className="space-y-4">
              {mcQuestions.map((q) => {
                ...
                return (
                  <div
                    key={q.id}
                    className={`p-5 rounded-xl border-l-4 ${status.isCorrect
                                ...
                                <div key={key} className="bg-white  p-3 rounded-md border-2 border-gray-200 ">
                                  <div className="flex items-start gap-2">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      {explanation && (
                                        <div className={`mt-2 p-2 rounded text-xs font-medium ${isCorrect
