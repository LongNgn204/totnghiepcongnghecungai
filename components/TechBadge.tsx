  ...
  return (
    <div className="fixed bottom-24 right-8 z-40 group">
      <div className="relative flex items-center justify-end">
        {/* Collapsible Content */}
        <div className="absolute right-0 bottom-0 bg-white/90  backdrop-blur-2xl rounded-[2rem] shadow-2xl shadow-blue-500/20 border border-white/50  p-1.5 w-14 h-14 group-hover:w-72 group-hover:h-auto group-hover:p-5 overflow-hidden transition-all duration-500 cubic-bezier(0.34, 1.56, 0.64, 1) origin-bottom-right">
          <div className="w-64 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
            <h4 className="font-bold text-sm mb-4 text-gray-800  flex items-center gap-2 border-b border-gray-100  pb-2">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center gap-3 text-xs font-medium text-gray-700  bg-white/60  p-3 rounded-2xl border border-gray-100  hover:scale-[1.02] hover:shadow-md transition-all cursor-default group/item">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-purple-900 ">Gemini 2.0 Flash</span>
              ...
              <div className="flex items-center gap-3 text-xs font-medium text-gray-700  bg-white/60  p-3 rounded-2xl border border-gray-100  hover:scale-[1.02] hover:shadow-md transition-all cursor-default group/item">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-cyan-900 ">React 19 + TS</span>
              ...
              <div className="flex items-center gap-3 text-xs font-medium text-gray-700  bg-white/60  p-3 rounded-2xl border border-gray-100  hover:scale-[1.02] hover:shadow-md transition-all cursor-default group/item">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-yellow-900 ">Vite + Tailwind</span>
